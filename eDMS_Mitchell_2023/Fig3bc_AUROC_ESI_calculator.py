...
rprofile['ectmrna_ic'] = {}
rprofile['ectmrna_ic']['DMS'] = [ReactivityProfile('Profiles_for_ESI/tmRNA-ic/Parsed_DM_tmRNA_ic_Mara_Rep1_22dev-DMS_Escherichia_coli_tmRNA_profile.txt'),
                                 ReactivityProfile('Profiles_for_ESI/tmRNA-ic/Parsed_DM_tmRNA_ic_Mara_Rep2_22dev-DMS_Escherichia_coli_tmRNA_profile.txt'),
                                 ReactivityProfile('Profiles_for_ESI/tmRNA-ic/tmRNA-ic-Old-22dev_DMS-Mara-Parsed_Escherichia_coli_tmRNA_profile.txt')]
rprofile['ectmrna_ic']['2A3'] = ReactivityProfile('Profiles_for_ESI/tmRNA-ic/tmRNA_DInc_2A3_profile.txt')


rprofile['ectmrna_cf'] = {}
rprofile['ectmrna_cf']['DMS'] = [ReactivityProfile('Profiles_for_ESI/tmRNA-cf/Parsed_DM_tmRNA_cf_Mara_Rep1_22dev-DMS_Escherichia_coli_tmRNA_profile.txt'),
                                 ReactivityProfile('Profiles_for_ESI/tmRNA-cf/tmRNA-cf-Old-22dev_DMS-Mara-Parsed_Escherichia_coli_tmRNA_profile.txt')]
#rprofile['ectmrna_cf']['2A3'] = ReactivityProfile('SI_Analysis/2A3/Ecoli_tmRNA/DInc_Ecoli_tmRNA_cellfree_2A3_22dev_Escherichia_coli_tmRNA_profile.txt')



rprofile['hrnasep_ic'] = {}
rprofile['hrnasep_ic']['DMS'] = [ReactivityProfile('Profiles_for_ESI/RnaseP-ic/Counted-RnaseP-rep1-Mara-22dev-DMS_RnaseP_profile.txt'),
                                 ReactivityProfile('Profiles_for_ESI/RnaseP-ic/Counted-RnaseP-rep2-Mara-22dev-DMS_RnaseP_profile.txt'),
                                 ReactivityProfile('Profiles_for_ESI/RnaseP-ic/Counted_FloatCells_RnaseP_DMS-pH8_22dev-DMS_RnaseP_profile.txt')]

rprofile['hrnasep_ic']['2A3'] = [ReactivityProfile('Profiles_for_ESI/RnaseP-ic/Counted_RnaseP_2A3_22dev-None_RnaseP_profile.txt'),
                                 ReactivityProfile('Profiles_for_ESI/RnaseP-ic/Counted_FloatCells_RnaseP_2A3_22dev-None_RnaseP_profile.txt')]

rprofile['hrmrp_ic'] = {}
rprofile['hrmrp_ic']['DMS'] = [ReactivityProfile('Profiles_for_ESI/RMRP-ic/Counted-RMRP-rep1-Mara-22dev-DMS_RMRP_profile.txt'),
                               ReactivityProfile('Profiles_for_ESI/RMRP-ic/Counted-RMRP-rep2-Mara-22dev-DMS_RMRP_profile.txt'),
                               ReactivityProfile('Profiles_for_ESI/RMRP-ic/RMRP_Rep1_DMS_pH8_Mara_22dev_DMS_RMRP_profile.txt'),
                               ReactivityProfile('Profiles_for_ESI/RMRP-ic/Counted_FloatCells_RMRP_DMS-pH8_22dev-DMS_RMRP_profile.txt')]
rprofile['hrmrp_ic']['2A3'] = [ReactivityProfile('Profiles_for_ESI/RMRP-ic/Counted_RMRP_2A3_22dev-None_RMRP_profile.txt'),
                               ReactivityProfile('Profiles_for_ESI/RMRP-ic/Counted_FloatCells_RMRP_2A3_22dev-None_RMRP_profile.txt')]


rprofile['hrrna_ic'] = {}
rprofile['hrrna_ic']['DMS'] = [mergeprofile(['Profiles_for_ESI/HEK293_rRNA-ic/18S_human_NXT_1_NR_145820.1_Homo_sapiens_RNA__18S_ribosomal_N1__RNA18SN1___ribosomal_RNA_profile.txt',
                                             'Profiles_for_ESI/HEK293_rRNA-ic/28S_human_NXT_1_NR_003287.4_Homo_sapiens_RNA__28S_ribosomal_N5__RNA28SN5___ribosomal_RNA_profile.txt']),
                               mergeprofile(['Profiles_for_ESI/HEK293_rRNA-ic/18S_human_IDT_rep2_NR_145820.1_Homo_sapiens_RNA__18S_ribosomal_N1__RNA18SN1___ribosomal_RNA_profile.txt',
                                             'Profiles_for_ESI/HEK293_rRNA-ic/28S_human_IDT_rep2_NR_003287.4_Homo_sapiens_RNA__28S_ribosomal_N5__RNA28SN5___ribosomal_RNA_profile.txt'])]

rprofile['hrrna_ic']['2A3x'] = mergeprofile(['Profiles_for_ESI/HEK293_rRNA-ic/DInc_HEK293_rRNA-ic_2A3_18S.xml', 
                                             'Profiles_for_ESI/HEK293_rRNA-ic/DInc_HEK293_rRNA-ic_2A3_28S.xml'], True)

# adjust the files from Danny's lab to align with our files
rprofile['hrrna_ic']['2A3x'].sequence = np.insert(rprofile['hrrna_ic']['2A3x'].sequence, 6674, 'C') 
rprofile['hrrna_ic']['2A3x'].normprofile = np.insert(rprofile['hrrna_ic']['2A3x'].normprofile, 6674, np.nan) 
...
CTs['hrrna'] = RNAtools.CT('Files/Human_18S_rRNA_N5_CT.ct', filterNC=True, filterSingle=True)
tmp = RNAtools.CT('Files/Human_28S_rRNA_N5_CT.ct', filterNC=True, filterSingle=True)
CTs['hrrna'].ct.extend(tmp.ct)

CTs['ectmrna'] = RNAtools.CT('Files/tmRNA_CT.ct', filterNC=True, filterSingle=True)
CTs['hrnasep'] = RNAtools.CT('Files/RNaseP_REF.ct',filterNC=True, filterSingle=True)
CTs['hrmrp'] = RNAtools.CT('Files/RMRP_REF.ct',filterNC=True, filterSingle=True)
...
colors_2a3 = ['0.3', '0.6', 'k']
for r_index, rna in enumerate(('hrmrp_ic', 'hrnasep_ic', 'hrrna_ic', 'ecrrna_cf', 'ectmrna_cf', 'ecrrna_ic', 'ectmrna_ic')):
...
ax2.set_xticklabels(['RMRP\nIn-cell','RNase P\nIn-cell','h rRNA\nIn-cell','ec rRNA\nCell-free','ec tmRNA\nCell-free','ec rRNA\nIn-cell','ec tmRNA\nIn-cell'])
ax2.set_ylabel('ESI (bits)')

fig.savefig('Output/dm_Fig3C_ESI_AUC_GammaMix.pdf')
...
fig.savefig('Output/dm_Fig3B_ESI_Histogram_GammaMix.pdf')
