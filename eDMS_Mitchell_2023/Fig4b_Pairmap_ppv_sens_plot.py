...
ecolors = ('sandybrown', 'red', 'dimgray', 'sandybrown', 'red', 'sandybrown', 'red', 'dimgray', 'sandybrown', 'red', 'sandybrown', 'red', 'sandybrown', 'red', 'sandybrown', 'red', 'sandybrown', 'red', 'sandybrown', 'red')
fcolors = ('sandybrown', 'red', 'dimgray', 'white', 'white', 'sandybrown', 'red', 'dimgray', 'white', 'white', 'sandybrown', 'red', 'white', 'white', 'sandybrown', 'red', 'sandybrown', 'red', 'sandybrown', 'red')

x_pos = (0,1,2,0,1,5,6,7,5,6,10,11,10,11,14,15,18,19,22,23)
...
for z, ztype in enumerate(names):
    ...
    for az in range(y_use.shape[0]):
        ax1[z].scatter(x_pos, y_use, s=60, marker='o', c = fcolors, edgecolors = ecolors, linewidths=2)
    ax1[z].set_ylabel(ztype)
    ax1[z].set_ylim(-5,105)
    
#fig.suptitle('PPV and Sensitivity Box Plot: ' + ptype_name + ' ' + outputname)
fig.tight_layout()

# Save box plot as PDF
outPath = 'Output/Pairmap_MSFIG_Boxplot_' + outputname + '_' + ptype_name + '.pdf'
